...
import com.github.michaelkhw.playground.zero.pi.msg.*;
 ...
 */
public class AkkaPiCalculator implements PiCalculator {
    ...
    public static class Worker extends UntypedActor {
        ...
        public void onReceive(Object o) throws Exception {
            if (o instanceof IterationCalcRequestMsg) {
                ...
                double d = SerialPiCalculator.calculateCore(msg.getStart(), msg.getEnd());
